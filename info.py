...
API_ID = int(environ.get('API_ID', '21628597'))
API_HASH = environ.get('API_HASH', '8745948d4e36a902827f5558db34f5df')
BOT_TOKEN = environ.get('BOT_TOKEN', "6954753520:AAG_GSMZUlSqrQ0n6vE3mTvaoPASfI_Tlzg")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6442587141 5442776902').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002098127439').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://maggibot:maggibot@cluster0.u1knxrr.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002041762661'))
